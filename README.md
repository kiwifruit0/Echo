...
The forum questions shown for each user are determined by users' "interests" which they choose when registering, and are automatically updated from the type of questions they ask.
